...
class DanfeService extends Common
{
    ...
    /**
     * Salva o PDF no diretorio indicado
     * @return void
     */
    public function save()
    {
        $fileName = $this->infNFe->getAttribute("Id") . '.pdf';
        $file = $this->pdfDir . DIRECTORY_SEPARATOR . $fileName;
    ...
    protected function pRodape($x, $y)
    {
        ...
        $texto = " Emitido pelo sistema SD5 v.1.5"; //$this->creditos .  "  Powered by NFePHP";
